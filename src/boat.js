...
export default class Boat extends paper.Group {
    constructor(posx, posy) {
        ...
        this.rudder = 0;
        this.speed = 0;
        // applyMatrix true for intersection test to work on this.hull
    ...
    update(timedelta) {
        //let dir = this.matrix.transform(new paper.Point(0.0, 1.0));
        //let pos = this.matrix.translation;
        //dir = dir.subtract(pos);
        //console.log(this.matrix, this.hull.matrix);
        let dir = new paper.Point(0.0, 1.0).rotate(this.heading);
